...
public class ExecuteQ02 {
    public static void main(String[] args) throws SQLException {
        ...
        statement.execute("ALTER TABLE products ADD IF NOT EXISTS stock_quantity INT");

        statement.executeUpdate("INSERT INTO products VALUES (104, 'Laptop', 1500, 10)");
        statement.executeUpdate("INSERT INTO products VALUES (105, 'Smartphone', 900, 25)");
        statement.executeUpdate("INSERT INTO products VALUES (106, 'Keyboard', 40, 100)");
